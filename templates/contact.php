...
<section class="position-relative pt-5" style="overflow:hidden;">
<?php 
...
// $body .= '<tbody>';
// $body .= '<tr>';
// $body .= '<td style="text-align: center;"><img src="https://i-strategic.com/wp-content/uploads/2022/05/iStrategic-Logo-768x237.png" alt="Logo" width="200px" height="auto"/></td>';
// $body .= '</tr>';
// $body .= '</tbody>';
// $body .= '</table>';
